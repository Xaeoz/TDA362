...
float point_light_intensity_multiplier = 60000.0f;
...
//	drawScene(waterShaderProgram, lightViewMatrix, lightProjMatrix, lightViewMatrix, lightProjMatrix);
